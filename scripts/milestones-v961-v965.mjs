export const milestones = [
  {
    name: 'complianceizability',
    Name: 'Complianceizability',
    percent: 'complianceizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice complianceizability',
    metricDetail: 'billing invoice complianceizability',
    ...
    cap1: 'supportsBillingInvoiceComplianceizabilitySignals',
    cap2: 'supportsBillingRecordComplianceizabilitySignals',
    guidance:
      'Production complianceizability rollout validates billing invoice complianceizability, billing record complianceizability signals, billing webhook coverage, and scalingization readiness before production complianceizability tooling.',
    domains: [
      {
  ...
  {
    name: 'policyizability',
    Name: 'Policyizability',
    percent: 'policyizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership policyizability',
    metricDetail: 'membership policyizability',
    ...
    cap1: 'supportsMembershipPolicyizabilitySignals',
    cap2: 'supportsUsageEventPolicyizabilitySignals',
    guidance:
      'Production policyizability rollout validates membership policyizability, usage event policyizability signals, billing notification coverage, and healingization readiness before production policyizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'enforcementizability',
    Name: 'Enforcementizability',
    percent: 'enforcementizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key enforcementizability',
    metricDetail: 'idempotency key enforcementizability',
    ...
    cap1: 'supportsIdempotencyKeyEnforcementizabilitySignals',
    cap2: 'supportsUsageEventEnforcementizabilitySignals',
    guidance:
      'Production enforcementizability rollout validates idempotency key enforcementizability, usage event enforcementizability signals, billing webhook coverage, and remediationization readiness before production enforcementizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'assuranceizability',
    Name: 'Assuranceizability',
    percent: 'assuranceizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan assuranceizability',
    metricDetail: 'shield scan assuranceizability',
    ...
    cap1: 'supportsShieldScanAssuranceizabilitySignals',
    cap2: 'supportsProviderCredentialAssuranceizabilitySignals',
    guidance:
      'Production assuranceizability rollout validates shield scan assuranceizability, provider credential assuranceizability signals, billing webhook coverage, and reconciliationization readiness before production assuranceizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'attestationizability',
    Name: 'Attestationizability',
    percent: 'attestationizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification attestationizability',
    metricDetail: 'billing notification attestationizability',
    ...
    cap1: 'supportsBillingNotificationAttestationizabilitySignals',
    cap2: 'supportsBillingWebhookAttestationizabilitySignals',
    guidance:
      'Production attestationizability rollout validates billing notification attestationizability, billing webhook attestationizability signals, usage event coverage, and governanceization readiness before production attestationizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
