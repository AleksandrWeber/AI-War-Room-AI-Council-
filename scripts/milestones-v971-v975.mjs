export const milestones = [
  {
    name: 'auditingizability',
    Name: 'Auditingizability',
    percent: 'auditingizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice auditingizability',
    metricDetail: 'billing invoice auditingizability',
    ...
    cap1: 'supportsBillingInvoiceAuditingizabilitySignals',
    cap2: 'supportsBillingRecordAuditingizabilitySignals',
    guidance:
      'Production auditingizability rollout validates billing invoice auditingizability, billing record auditingizability signals, billing webhook coverage, and scalingization readiness before production auditingizability tooling.',
    domains: [
      {
  ...
  {
    name: 'accountabilityizability',
    Name: 'Accountabilityizability',
    percent: 'accountabilityizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership accountabilityizability',
    metricDetail: 'membership accountabilityizability',
    ...
    cap1: 'supportsMembershipAccountabilityizabilitySignals',
    cap2: 'supportsUsageEventAccountabilityizabilitySignals',
    guidance:
      'Production accountabilityizability rollout validates membership accountabilityizability, usage event accountabilityizability signals, billing notification coverage, and healingization readiness before production accountabilityizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'transparencyizability',
    Name: 'Transparencyizability',
    percent: 'transparencyizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key transparencyizability',
    metricDetail: 'idempotency key transparencyizability',
    ...
    cap1: 'supportsIdempotencyKeyTransparencyizabilitySignals',
    cap2: 'supportsUsageEventTransparencyizabilitySignals',
    guidance:
      'Production transparencyizability rollout validates idempotency key transparencyizability, usage event transparencyizability signals, billing webhook coverage, and remediationization readiness before production transparencyizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'oversightizability',
    Name: 'Oversightizability',
    percent: 'oversightizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan oversightizability',
    metricDetail: 'shield scan oversightizability',
    ...
    cap1: 'supportsShieldScanOversightizabilitySignals',
    cap2: 'supportsProviderCredentialOversightizabilitySignals',
    guidance:
      'Production oversightizability rollout validates shield scan oversightizability, provider credential oversightizability signals, billing webhook coverage, and reconciliationization readiness before production oversightizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  },
  {
    ...
    Name: 'Controlizability',
    percent: 'controlizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification controlizability',
    metricDetail: 'billing notification controlizability',
    ...
    cap1: 'supportsBillingNotificationControlizabilitySignals',
    cap2: 'supportsBillingWebhookControlizabilitySignals',
    guidance:
      'Production controlizability rollout validates billing notification controlizability, billing webhook controlizability signals, usage event coverage, and governanceization readiness before production controlizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
