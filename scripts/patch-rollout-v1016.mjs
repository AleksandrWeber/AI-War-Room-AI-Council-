...
import { milestones, patchMeta } from './milestones-v1016-v1020.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./ruleproofizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './ruleproofizability/ruleproofizability.module.js'")) {
...
if (!tests.includes("describe('ruleproofizability rollout integration'")) {
...
if (!app.includes("from './ruleproofizability-ui'")) {
...
console.log('Patched shared files for v5.516-v5.520 rollout milestones.')
