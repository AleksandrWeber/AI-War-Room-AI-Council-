...
import { milestones, patchMeta } from './milestones-v896-v900.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('hydrationizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('HydrationizabilityModule')) {
...
if (!tests.includes("describe('hydrationizability rollout integration'")) {
...
if (!app.includes('HydrationizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.396-v5.400 rollout milestones.')
