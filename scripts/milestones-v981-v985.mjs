export const milestones = [
  {
    name: 'riskizability',
    Name: 'Riskizability',
    percent: 'riskizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice riskizability',
    metricDetail: 'billing invoice riskizability',
    ...
    cap1: 'supportsBillingInvoiceRiskizabilitySignals',
    cap2: 'supportsBillingRecordRiskizabilitySignals',
    guidance:
      'Production riskizability rollout validates billing invoice riskizability, billing record riskizability signals, billing webhook coverage, and scalingization readiness before production riskizability tooling.',
    domains: [
      {
  ...
  {
    name: 'securityizability',
    Name: 'Securityizability',
    percent: 'securityizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership securityizability',
    metricDetail: 'membership securityizability',
    ...
    cap1: 'supportsMembershipSecurityizabilitySignals',
    cap2: 'supportsUsageEventSecurityizabilitySignals',
    guidance:
      'Production securityizability rollout validates membership securityizability, usage event securityizability signals, billing notification coverage, and healingization readiness before production securityizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'privacyizability',
    Name: 'Privacyizability',
    percent: 'privacyizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key privacyizability',
    metricDetail: 'idempotency key privacyizability',
    ...
    cap1: 'supportsIdempotencyKeyPrivacyizabilitySignals',
    cap2: 'supportsUsageEventPrivacyizabilitySignals',
    guidance:
      'Production privacyizability rollout validates idempotency key privacyizability, usage event privacyizability signals, billing webhook coverage, and remediationization readiness before production privacyizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  },
  {
    name: 'trustizability',
    Name: 'Trustizability',
    percent: 'trustizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan trustizability',
    metricDetail: 'shield scan trustizability',
    ...
    cap1: 'supportsShieldScanTrustizabilitySignals',
    cap2: 'supportsProviderCredentialTrustizabilitySignals',
    guidance:
      'Production trustizability rollout validates shield scan trustizability, provider credential trustizability signals, billing webhook coverage, and reconciliationization readiness before production trustizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'integrityizability',
    Name: 'Integrityizability',
    percent: 'integrityizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification integrityizability',
    metricDetail: 'billing notification integrityizability',
    ...
    cap1: 'supportsBillingNotificationIntegrityizabilitySignals',
    cap2: 'supportsBillingWebhookIntegrityizabilitySignals',
    guidance:
      'Production integrityizability rollout validates billing notification integrityizability, billing webhook integrityizability signals, usage event coverage, and governanceization readiness before production integrityizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
