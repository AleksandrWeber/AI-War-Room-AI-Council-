...
import { milestones, patchMeta } from './milestones-v1011-v1015.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./policyproofizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './policyproofizability/policyproofizability.module.js'")) {
...
if (!tests.includes("describe('policyproofizability rollout integration'")) {
...
if (!app.includes("from './policyproofizability-ui'")) {
...
console.log('Patched shared files for v5.511-v5.515 rollout milestones.')
