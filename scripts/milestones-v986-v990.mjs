export const milestones = [
  {
    name: 'threatizability',
    Name: 'Threatizability',
    percent: 'threatizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice threatizability',
    metricDetail: 'billing invoice threatizability',
    ...
    cap1: 'supportsBillingInvoiceThreatizabilitySignals',
    cap2: 'supportsBillingRecordThreatizabilitySignals',
    guidance:
      'Production threatizability rollout validates billing invoice threatizability, billing record threatizability signals, billing webhook coverage, and scalingization readiness before production threatizability tooling.',
    domains: [
      {
  ...
  {
    name: 'vulnerabilityizability',
    Name: 'Vulnerabilityizability',
    percent: 'vulnerabilityizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership vulnerabilityizability',
    metricDetail: 'membership vulnerabilityizability',
    ...
    check1: {
      ...
      name: 'membership_vulnerabilityizability',
      label: 'Membership vulnerabilityizability',
      table: 'workspace_memberships',
    },
    check2: {
      key: 'usageEventsTableExists',
      name: 'usage_event_vulnerabilityizability',
      label: 'Usage event vulnerabilityizability',
      table: 'usage_events',
    },
    ...
    cap1: 'supportsMembershipVulnerabilityizabilitySignals',
    cap2: 'supportsUsageEventVulnerabilityizabilitySignals',
    guidance:
      'Production vulnerabilityizability rollout validates membership vulnerabilityizability, usage event vulnerabilityizability signals, billing notification coverage, and healingization readiness before production vulnerabilityizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'mitigationizability',
    Name: 'Mitigationizability',
    percent: 'mitigationizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key mitigationizability',
    metricDetail: 'idempotency key mitigationizability',
    ...
    cap1: 'supportsIdempotencyKeyMitigationizabilitySignals',
    cap2: 'supportsUsageEventMitigationizabilitySignals',
    guidance:
      'Production mitigationizability rollout validates idempotency key mitigationizability, usage event mitigationizability signals, billing webhook coverage, and remediationization readiness before production mitigationizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'hardeningizability',
    Name: 'Hardeningizability',
    percent: 'hardeningizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan hardeningizability',
    metricDetail: 'shield scan hardeningizability',
    ...
    cap1: 'supportsShieldScanHardeningizabilitySignals',
    cap2: 'supportsProviderCredentialHardeningizabilitySignals',
    guidance:
      'Production hardeningizability rollout validates shield scan hardeningizability, provider credential hardeningizability signals, billing webhook coverage, and reconciliationization readiness before production hardeningizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  },
  {
    ...
    Name: 'Segregationizability',
    percent: 'segregationizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification segregationizability',
    metricDetail: 'billing notification segregationizability',
    ...
    cap1: 'supportsBillingNotificationSegregationizabilitySignals',
    cap2: 'supportsBillingWebhookSegregationizabilitySignals',
    guidance:
      'Production segregationizability rollout validates billing notification segregationizability, billing webhook segregationizability signals, usage event coverage, and governanceization readiness before production segregationizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
