...
import { milestones, patchMeta } from './milestones-v941-v945.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('orchestrationizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('OrchestrationizabilityModule')) {
...
if (!tests.includes("describe('orchestrationizability rollout integration'")) {
...
if (!app.includes('OrchestrationizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.441-v5.445 rollout milestones.')
