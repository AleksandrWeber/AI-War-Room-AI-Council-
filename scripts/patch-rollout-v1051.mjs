...
import { milestones, patchMeta } from './milestones-v1051-v1055.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./validityvaultizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './validityvaultizability/validityvaultizability.module.js'")) {
...
if (!tests.includes("describe('validityvaultizability rollout integration'")) {
...
if (!app.includes("from './validityvaultizability-ui'")) {
...
console.log('Patched shared files for v5.551-v5.555 rollout milestones.')
