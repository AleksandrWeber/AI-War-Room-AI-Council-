...
import { milestones, patchMeta } from './milestones-v931-v935.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('transformizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('TransformizabilityModule')) {
...
if (!tests.includes("describe('transformizability rollout integration'")) {
...
if (!app.includes('TransformizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.431-v5.435 rollout milestones.')
