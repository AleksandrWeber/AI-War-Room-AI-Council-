...
import { milestones, patchMeta } from './milestones-v1041-v1045.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./registryjournalizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './registryjournalizability/registryjournalizability.module.js'")) {
...
if (!tests.includes("describe('registryjournalizability rollout integration'")) {
...
if (!app.includes("from './registryjournalizability-ui'")) {
...
console.log('Patched shared files for v5.541-v5.545 rollout milestones.')
