...
import { milestones, patchMeta } from './milestones-v961-v965.mjs'

const root = join(import.meta.dirname, '..')
const BASE = {
  name: 'governanceizability',
  Name: 'Governanceizability',
}
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./complianceizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './complianceizability/complianceizability.module.js'")) {
...
if (!tests.includes("describe('complianceizability rollout integration'")) {
...
if (!app.includes("from './complianceizability-ui'")) {
  ...
  app = app.replace(
    '  GovernanceizabilityAdminSummaryResponse,\n  RunCapabilitiesResponse,',
    `  GovernanceizabilityAdminSummaryResponse,\n${typeBlock}\n  RunCapabilitiesResponse,`,
  )
...
console.log('Patched shared files for v5.461-v5.465 rollout milestones.')
