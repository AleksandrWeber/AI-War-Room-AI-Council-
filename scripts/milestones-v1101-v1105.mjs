export const milestones = [
  {
    name: 'orchestrabilityvaultizability',
    Name: 'Orchestrabilityvaultizability',
    percent: 'orchestrabilityvaultizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice orchestrabilityvaultizability',
    metricDetail: 'billing invoice orchestrabilityvaultizability',
    ...
    cap1: 'supportsBillingInvoiceOrchestrabilityvaultizabilitySignals',
    cap2: 'supportsBillingRecordOrchestrabilityvaultizabilitySignals',
    guidance:
      'Production orchestrabilityvaultizability rollout validates billing invoice orchestrabilityvaultizability, billing record orchestrabilityvaultizability signals, billing webhook coverage, and scalingization readiness before production orchestrabilityvaultizability tooling.',
    domains: [
      {
  ...
  {
    name: 'schedulabilityvaultizability',
    Name: 'Schedulabilityvaultizability',
    percent: 'schedulabilityvaultizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership schedulabilityvaultizability',
    metricDetail: 'membership schedulabilityvaultizability',
    ...
    cap1: 'supportsMembershipSchedulabilityvaultizabilitySignals',
    cap2: 'supportsUsageEventSchedulabilityvaultizabilitySignals',
    guidance:
      'Production schedulabilityvaultizability rollout validates membership schedulabilityvaultizability, usage event schedulabilityvaultizability signals, billing notification coverage, and healingization readiness before production schedulabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'automatabilityvaultizability',
    Name: 'Automatabilityvaultizability',
    percent: 'automatabilityvaultizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key automatabilityvaultizability',
    metricDetail: 'idempotency key automatabilityvaultizability',
    ...
    cap1: 'supportsIdempotencyKeyAutomatabilityvaultizabilitySignals',
    cap2: 'supportsUsageEventAutomatabilityvaultizabilitySignals',
    guidance:
      'Production automatabilityvaultizability rollout validates idempotency key automatabilityvaultizability, usage event automatabilityvaultizability signals, billing webhook coverage, and remediationization readiness before production automatabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'monitorabilityvaultizability',
    Name: 'Monitorabilityvaultizability',
    percent: 'monitorabilityvaultizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan monitorabilityvaultizability',
    metricDetail: 'shield scan monitorabilityvaultizability',
    ...
    cap1: 'supportsShieldScanMonitorabilityvaultizabilitySignals',
    cap2: 'supportsProviderCredentialMonitorabilityvaultizabilitySignals',
    guidance:
      'Production monitorabilityvaultizability rollout validates shield scan monitorabilityvaultizability, provider credential monitorabilityvaultizability signals, billing webhook coverage, and reconciliationization readiness before production monitorabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'predictabilityvaultizability',
    Name: 'Predictabilityvaultizability',
    percent: 'predictabilityvaultizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification predictabilityvaultizability',
    metricDetail: 'billing notification predictabilityvaultizability',
    ...
    cap1: 'supportsBillingNotificationPredictabilityvaultizabilitySignals',
    cap2: 'supportsBillingWebhookPredictabilityvaultizabilitySignals',
    guidance:
      'Production predictabilityvaultizability rollout validates billing notification predictabilityvaultizability, billing webhook predictabilityvaultizability signals, usage event coverage, and governanceization readiness before production predictabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
