export const milestones = [
  {
    name: 'assurancevaultizability',
    Name: 'Assurancevaultizability',
    percent: 'assurancevaultizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice assurancevaultizability',
    metricDetail: 'billing invoice assurancevaultizability',
    ...
    cap1: 'supportsBillingInvoiceAssurancevaultizabilitySignals',
    cap2: 'supportsBillingRecordAssurancevaultizabilitySignals',
    guidance:
      'Production assurancevaultizability rollout validates billing invoice assurancevaultizability, billing record assurancevaultizability signals, billing webhook coverage, and scalingization readiness before production assurancevaultizability tooling.',
    domains: [
      {
  ...
  {
    name: 'auditabilityvaultizability',
    Name: 'Auditabilityvaultizability',
    percent: 'auditabilityvaultizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership auditabilityvaultizability',
    metricDetail: 'membership auditabilityvaultizability',
    ...
    cap1: 'supportsMembershipAuditabilityvaultizabilitySignals',
    cap2: 'supportsUsageEventAuditabilityvaultizabilitySignals',
    guidance:
      'Production auditabilityvaultizability rollout validates membership auditabilityvaultizability, usage event auditabilityvaultizability signals, billing notification coverage, and healingization readiness before production auditabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'inspectabilityvaultizability',
    Name: 'Inspectabilityvaultizability',
    percent: 'inspectabilityvaultizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key inspectabilityvaultizability',
    metricDetail: 'idempotency key inspectabilityvaultizability',
    ...
    cap1: 'supportsIdempotencyKeyInspectabilityvaultizabilitySignals',
    cap2: 'supportsUsageEventInspectabilityvaultizabilitySignals',
    guidance:
      'Production inspectabilityvaultizability rollout validates idempotency key inspectabilityvaultizability, usage event inspectabilityvaultizability signals, billing webhook coverage, and remediationization readiness before production inspectabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'reproducibilityvaultizability',
    Name: 'Reproducibilityvaultizability',
    percent: 'reproducibilityvaultizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan reproducibilityvaultizability',
    metricDetail: 'shield scan reproducibilityvaultizability',
    ...
    cap1: 'supportsShieldScanReproducibilityvaultizabilitySignals',
    cap2: 'supportsProviderCredentialReproducibilityvaultizabilitySignals',
    guidance:
      'Production reproducibilityvaultizability rollout validates shield scan reproducibilityvaultizability, provider credential reproducibilityvaultizability signals, billing webhook coverage, and reconciliationization readiness before production reproducibilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'credibilityvaultizability',
    Name: 'Credibilityvaultizability',
    percent: 'credibilityvaultizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification credibilityvaultizability',
    metricDetail: 'billing notification credibilityvaultizability',
    ...
    cap1: 'supportsBillingNotificationCredibilityvaultizabilitySignals',
    cap2: 'supportsBillingWebhookCredibilityvaultizabilitySignals',
    guidance:
      'Production credibilityvaultizability rollout validates billing notification credibilityvaultizability, billing webhook credibilityvaultizability signals, usage event coverage, and governanceization readiness before production credibilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
