...
import { milestones, patchMeta } from './milestones-v986-v990.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./threatizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './threatizability/threatizability.module.js'")) {
...
if (!tests.includes("describe('threatizability rollout integration'")) {
...
if (!app.includes("from './threatizability-ui'")) {
...
console.log('Patched shared files for v5.486-v5.490 rollout milestones.')
