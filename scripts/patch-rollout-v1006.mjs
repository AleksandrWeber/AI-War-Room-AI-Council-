...
import { milestones, patchMeta } from './milestones-v1006-v1010.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./governancetrackizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './governancetrackizability/governancetrackizability.module.js'")) {
...
if (!tests.includes("describe('governancetrackizability rollout integration'")) {
...
if (!app.includes("from './governancetrackizability-ui'")) {
...
console.log('Patched shared files for v5.506-v5.510 rollout milestones.')
