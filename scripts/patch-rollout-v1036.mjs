...
import { milestones, patchMeta } from './milestones-v1036-v1040.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./compliancejournalizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './compliancejournalizability/compliancejournalizability.module.js'")) {
...
if (!tests.includes("describe('compliancejournalizability rollout integration'")) {
...
if (!app.includes("from './compliancejournalizability-ui'")) {
...
console.log('Patched shared files for v5.536-v5.540 rollout milestones.')
