...
import { milestones, patchMeta } from './milestones-v891-v895.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('replicationizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('ReplicationizabilityModule')) {
...
if (!tests.includes("describe('replicationizability rollout integration'")) {
...
if (!app.includes('ReplicationizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.391-v5.395 rollout milestones.')
