...
import { milestones, patchMeta } from './milestones-v1021-v1025.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./compliancechainizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './compliancechainizability/compliancechainizability.module.js'")) {
...
if (!tests.includes("describe('compliancechainizability rollout integration'")) {
...
if (!app.includes("from './compliancechainizability-ui'")) {
...
console.log('Patched shared files for v5.521-v5.525 rollout milestones.')
