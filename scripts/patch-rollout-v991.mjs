...
import { milestones, patchMeta } from './milestones-v991-v995.mjs'

const root = join(import.meta.dirname, '..')
const BASE = {
  name: 'segregationizability',
  Name: 'Segregationizability',
}
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./confidentialityizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './confidentialityizability/confidentialityizability.module.js'")) {
...
if (!tests.includes("describe('confidentialityizability rollout integration'")) {
...
if (!app.includes("from './confidentialityizability-ui'")) {
...
console.log('Patched shared files for v5.491-v5.495 rollout milestones.')
