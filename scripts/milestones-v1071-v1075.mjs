export const milestones = [
  {
    name: 'attributabilityvaultizability',
    Name: 'Attributabilityvaultizability',
    percent: 'attributabilityvaultizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice attributabilityvaultizability',
    metricDetail: 'billing invoice attributabilityvaultizability',
    ...
    cap1: 'supportsBillingInvoiceAttributabilityvaultizabilitySignals',
    cap2: 'supportsBillingRecordAttributabilityvaultizabilitySignals',
    guidance:
      'Production attributabilityvaultizability rollout validates billing invoice attributabilityvaultizability, billing record attributabilityvaultizability signals, billing webhook coverage, and scalingization readiness before production attributabilityvaultizability tooling.',
    domains: [
      {
  ...
  {
    name: 'identifiabilityvaultizability',
    Name: 'Identifiabilityvaultizability',
    percent: 'identifiabilityvaultizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership identifiabilityvaultizability',
    metricDetail: 'membership identifiabilityvaultizability',
    ...
    cap1: 'supportsMembershipIdentifiabilityvaultizabilitySignals',
    cap2: 'supportsUsageEventIdentifiabilityvaultizabilitySignals',
    guidance:
      'Production identifiabilityvaultizability rollout validates membership identifiabilityvaultizability, usage event identifiabilityvaultizability signals, billing notification coverage, and healingization readiness before production identifiabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'comparabilityvaultizability',
    Name: 'Comparabilityvaultizability',
    percent: 'comparabilityvaultizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key comparabilityvaultizability',
    metricDetail: 'idempotency key comparabilityvaultizability',
    ...
    cap1: 'supportsIdempotencyKeyComparabilityvaultizabilitySignals',
    cap2: 'supportsUsageEventComparabilityvaultizabilitySignals',
    guidance:
      'Production comparabilityvaultizability rollout validates idempotency key comparabilityvaultizability, usage event comparabilityvaultizability signals, billing webhook coverage, and remediationization readiness before production comparabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'distinguishabilityvaultizability',
    Name: 'Distinguishabilityvaultizability',
    percent: 'distinguishabilityvaultizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan distinguishabilityvaultizability',
    metricDetail: 'shield scan distinguishabilityvaultizability',
    ...
    cap1: 'supportsShieldScanDistinguishabilityvaultizabilitySignals',
    cap2: 'supportsProviderCredentialDistinguishabilityvaultizabilitySignals',
    guidance:
      'Production distinguishabilityvaultizability rollout validates shield scan distinguishabilityvaultizability, provider credential distinguishabilityvaultizability signals, billing webhook coverage, and reconciliationization readiness before production distinguishabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'assignabilityvaultizability',
    Name: 'Assignabilityvaultizability',
    percent: 'assignabilityvaultizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification assignabilityvaultizability',
    metricDetail: 'billing notification assignabilityvaultizability',
    ...
    cap1: 'supportsBillingNotificationAssignabilityvaultizabilitySignals',
    cap2: 'supportsBillingWebhookAssignabilityvaultizabilitySignals',
    guidance:
      'Production assignabilityvaultizability rollout validates billing notification assignabilityvaultizability, billing webhook assignabilityvaultizability signals, usage event coverage, and governanceization readiness before production assignabilityvaultizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
