...
const milestones = [
  {
    ...
    metricDomain: 'provider_credentials',
    metricLabel: 'Provider credential attestation',
    metricDetail: 'provider credential attestation',
    ...
    check2: {
      key: 'providerCredentialsTableExists',
      name: 'provider_credential_attestation',
      label: 'Provider credential attestation',
      table: 'workspace_provider_credentials',
    },
    check3Key: 'modelHealthEventsTableExists',
    coverageKeys: {
      model_registry_entries: 'modelRegistryEntriesTableExists',
      model_health_events: 'modelHealthEventsTableExists',
      workspace_provider_credentials: 'providerCredentialsTableExists',
    },
    readiness: 'verification_readiness_signal',
    readinessLabel: 'Verification readiness signal',
    readinessDetail:
      'Model registry entries, health events, and provider credentials support verification readiness.',
    cap1: 'supportsModelRegistryAttestationSignals',
    cap2: 'supportsProviderCredentialAttestationSignals',
    guidance:
      'Production attestation rollout validates model registry attestation, provider credential attestation signals, health event coverage, and verification readiness before production attestation tooling.',
    domains: [
      {
  ...
  },
  {
    ...
    metricDetail: 'moderator synthesis authenticity',
    ...
    readiness: 'origin_readiness_signal',
    readinessLabel: 'Origin readiness signal',
    readinessDetail:
      'Moderator syntheses, agent outputs, and persisted artifacts support origin readiness.',
    cap1: 'supportsSynthesisAuthenticitySignals',
    cap2: 'supportsAgentOutputAuthenticitySignals',
    guidance:
      'Production authenticity rollout validates synthesis authenticity, agent output authenticity signals, artifact coverage, and origin readiness before production authenticity tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  },
  {
    ...
    metricDetail: 'usage provenance',
    action: 'refresh_provenance_summary',
    tables: ['usage_events', 'agent_outputs', 'artifacts'],
    check1: {
    ...
    readiness: 'lineage_readiness_signal',
    readinessLabel: 'Lineage readiness signal',
    readinessDetail:
      'Usage events, agent outputs, and persisted artifacts support lineage readiness.',
    cap1: 'supportsUsageProvenanceSignals',
    cap2: 'supportsAgentOutputProvenanceSignals',
    guidance:
      'Production provenance rollout validates usage provenance, agent output provenance signals, artifact coverage, and lineage readiness before production provenance tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  },
  {
    ...
    metricDetail: 'billing invoice verifiability',
    ...
    readiness: 'evidence_readiness_signal',
    readinessLabel: 'Evidence readiness signal',
    readinessDetail:
      'Billing invoices, webhook events, and meter usage reports support evidence readiness.',
    cap1: 'supportsBillingInvoiceVerifiabilitySignals',
    cap2: 'supportsBillingWebhookVerifiabilitySignals',
    guidance:
      'Production verifiability rollout validates billing invoice verifiability, billing webhook verifiability signals, meter usage reporting coverage, and evidence readiness before production verifiability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  },
  {
    ...
    metricDetail: 'billing notification confirmability',
    ...
    readiness: 'acknowledgment_readiness_signal',
    readinessLabel: 'Acknowledgment readiness signal',
    readinessDetail:
      'Billing notifications, workspace usage limits, and meter usage reports support acknowledgment readiness.',
    cap1: 'supportsBillingNotificationConfirmabilitySignals',
    cap2: 'supportsUsageLimitConfirmabilitySignals',
    guidance:
      'Production confirmability rollout validates billing notification confirmability, usage limit confirmability signals, meter usage reporting coverage, and acknowledgment readiness before production confirmability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
