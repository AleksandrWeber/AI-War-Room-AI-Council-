export const milestones = [
  {
    name: 'complianceledgerizability',
    Name: 'Complianceledgerizability',
    percent: 'complianceledgerizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice complianceledgerizability',
    metricDetail: 'billing invoice complianceledgerizability',
    ...
    cap1: 'supportsBillingInvoiceComplianceledgerizabilitySignals',
    cap2: 'supportsBillingRecordComplianceledgerizabilitySignals',
    guidance:
      'Production complianceledgerizability rollout validates billing invoice complianceledgerizability, billing record complianceledgerizability signals, billing webhook coverage, and scalingization readiness before production complianceledgerizability tooling.',
    domains: [
      {
  ...
  {
    name: 'notarledgerizability',
    Name: 'Notarledgerizability',
    percent: 'notarledgerizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership notarledgerizability',
    metricDetail: 'membership notarledgerizability',
    ...
    cap1: 'supportsMembershipNotarledgerizabilitySignals',
    cap2: 'supportsUsageEventNotarledgerizabilitySignals',
    guidance:
      'Production notarledgerizability rollout validates membership notarledgerizability, usage event notarledgerizability signals, billing notification coverage, and healingization readiness before production notarledgerizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'witnessledgerizability',
    Name: 'Witnessledgerizability',
    percent: 'witnessledgerizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key witnessledgerizability',
    metricDetail: 'idempotency key witnessledgerizability',
    ...
    cap1: 'supportsIdempotencyKeyWitnessledgerizabilitySignals',
    cap2: 'supportsUsageEventWitnessledgerizabilitySignals',
    guidance:
      'Production witnessledgerizability rollout validates idempotency key witnessledgerizability, usage event witnessledgerizability signals, billing webhook coverage, and remediationization readiness before production witnessledgerizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'proofregistryizability',
    Name: 'Proofregistryizability',
    percent: 'proofregistryizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan proofregistryizability',
    metricDetail: 'shield scan proofregistryizability',
    ...
    cap1: 'supportsShieldScanProofregistryizabilitySignals',
    cap2: 'supportsProviderCredentialProofregistryizabilitySignals',
    guidance:
      'Production proofregistryizability rollout validates shield scan proofregistryizability, provider credential proofregistryizability signals, billing webhook coverage, and reconciliationization readiness before production proofregistryizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'auditregistryizability',
    Name: 'Auditregistryizability',
    percent: 'auditregistryizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification auditregistryizability',
    metricDetail: 'billing notification auditregistryizability',
    ...
    cap1: 'supportsBillingNotificationAuditregistryizabilitySignals',
    cap2: 'supportsBillingWebhookAuditregistryizabilitySignals',
    guidance:
      'Production auditregistryizability rollout validates billing notification auditregistryizability, billing webhook auditregistryizability signals, usage event coverage, and governanceization readiness before production auditregistryizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
