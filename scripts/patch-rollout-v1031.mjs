...
import { milestones, patchMeta } from './milestones-v1031-v1035.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./complianceledgerizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './complianceledgerizability/complianceledgerizability.module.js'")) {
...
if (!tests.includes("describe('complianceledgerizability rollout integration'")) {
...
if (!app.includes("from './complianceledgerizability-ui'")) {
...
console.log('Patched shared files for v5.531-v5.535 rollout milestones.')
