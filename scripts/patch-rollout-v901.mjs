...
import { milestones, patchMeta } from './milestones-v901-v905.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('refreshizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('RefreshizabilityModule')) {
...
if (!tests.includes("describe('refreshizability rollout integration'")) {
...
if (!app.includes('RefreshizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.401-v5.405 rollout milestones.')
