...
import { milestones, patchMeta } from './milestones-v936-v940.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('chainingizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('ChainingizabilityModule')) {
...
if (!tests.includes("describe('chainingizability rollout integration'")) {
...
if (!app.includes('ChainingizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.436-v5.440 rollout milestones.')
