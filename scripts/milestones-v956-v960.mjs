export const milestones = [
  {
    name: 'scalingizability',
    Name: 'Scalingizability',
    percent: 'scalingizabilityPercent',
    metricDomain: 'billing_invoices',
    metricLabel: 'Billing invoice scalingizability',
    metricDetail: 'billing invoice scalingizability',
    ...
    cap1: 'supportsBillingInvoiceScalingizabilitySignals',
    cap2: 'supportsBillingRecordScalingizabilitySignals',
    guidance:
      'Production scalingizability rollout validates billing invoice scalingizability, billing record scalingizability signals, billing webhook coverage, and scalingization readiness before production scalingizability tooling.',
    domains: [
      {
  ...
  {
    name: 'healingizability',
    Name: 'Healingizability',
    percent: 'healingizabilityPercent',
    metricDomain: 'workspace_memberships',
    metricLabel: 'Membership healingizability',
    metricDetail: 'membership healingizability',
    ...
    cap1: 'supportsMembershipHealingizabilitySignals',
    cap2: 'supportsUsageEventHealingizabilitySignals',
    guidance:
      'Production healingizability rollout validates membership healingizability, usage event healingizability signals, billing notification coverage, and healingization readiness before production healingizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'remediationizability',
    Name: 'Remediationizability',
    percent: 'remediationizabilityPercent',
    metricDomain: 'idempotency_keys',
    metricLabel: 'Idempotency key remediationizability',
    metricDetail: 'idempotency key remediationizability',
    ...
    cap1: 'supportsIdempotencyKeyRemediationizabilitySignals',
    cap2: 'supportsUsageEventRemediationizabilitySignals',
    guidance:
      'Production remediationizability rollout validates idempotency key remediationizability, usage event remediationizability signals, billing webhook coverage, and remediationization readiness before production remediationizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  {
    name: 'reconciliationizability',
    Name: 'Reconciliationizability',
    percent: 'reconciliationizabilityPercent',
    metricDomain: 'shield_scans',
    metricLabel: 'Shield scan reconciliationizability',
    metricDetail: 'shield scan reconciliationizability',
    ...
    cap1: 'supportsShieldScanReconciliationizabilitySignals',
    cap2: 'supportsProviderCredentialReconciliationizabilitySignals',
    guidance:
      'Production reconciliationizability rollout validates shield scan reconciliationizability, provider credential reconciliationizability signals, billing webhook coverage, and reconciliationization readiness before production reconciliationizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
  ...
  },
  {
    ...
    Name: 'Governanceizability',
    percent: 'governanceizabilityPercent',
    metricDomain: 'billing_notifications',
    metricLabel: 'Billing notification governanceizability',
    metricDetail: 'billing notification governanceizability',
    ...
    cap1: 'supportsBillingNotificationGovernanceizabilitySignals',
    cap2: 'supportsBillingWebhookGovernanceizabilitySignals',
    guidance:
      'Production governanceizability rollout validates billing notification governanceizability, billing webhook governanceizability signals, usage event coverage, and governanceization readiness before production governanceizability tooling.',
    domains: [
      {
        domain: 'completed_runs',
        tableName: 'runs',
