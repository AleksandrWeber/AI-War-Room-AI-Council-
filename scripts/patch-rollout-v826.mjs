...
import { milestones, patchMeta } from './milestones-v826-v830.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('compatibilizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('CompatibilizabilityModule')) {
...
if (!tests.includes("describe('compatibilizability rollout integration'")) {
...
if (!app.includes('CompatibilizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.326-v5.330 rollout milestones.')
