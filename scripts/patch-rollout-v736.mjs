...
import { milestones, patchMeta } from './milestones-v736-v740.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('consolidatizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('ConsolidatizabilityModule')) {
...
if (!tests.includes("describe('consolidatizability rollout integration'")) {
...
if (!app.includes('ConsolidatizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.236-v5.240 rollout milestones.')
