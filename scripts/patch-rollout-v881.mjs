...
import { milestones, patchMeta } from './milestones-v881-v885.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('compactionizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('CompactionizabilityModule')) {
...
if (!tests.includes("describe('compactionizability rollout integration'")) {
...
if (!app.includes('CompactionizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.381-v5.385 rollout milestones.')
