...
import { milestones, patchMeta } from './milestones-v951-v955.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('discoveryizability-rollout')) {
  index = index.replace(
...
if (!appModule.includes('DiscoveryizabilityModule')) {
...
if (!tests.includes("describe('discoveryizability rollout integration'")) {
...
if (!app.includes('DiscoveryizabilityRolloutResponse')) {
  ...
  app = app.replace(
    '  MeshingizabilityAdminSummaryResponse,\n  RunCapabilitiesResponse,',
    `  MeshingizabilityAdminSummaryResponse,\n${typeBlock}\n  RunCapabilitiesResponse,`,
  )
...
console.log('Patched shared files for v5.451-v5.455 rollout milestones.')
