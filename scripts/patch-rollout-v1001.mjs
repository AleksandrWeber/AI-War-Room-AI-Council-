...
import { milestones, patchMeta } from './milestones-v1001-v1005.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./provenanceizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './provenanceizability/provenanceizability.module.js'")) {
...
if (!tests.includes("describe('provenanceizability rollout integration'")) {
...
if (!app.includes("from './provenanceizability-ui'")) {
...
console.log('Patched shared files for v5.501-v5.505 rollout milestones.')
