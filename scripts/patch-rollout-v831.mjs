...
import { milestones, patchMeta } from './milestones-v831-v835.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('encapsulizability-rollout')) {
  index = index.replace(
...
if (!tests.includes("describe('encapsulizability rollout integration'")) {
...
if (!app.includes('EncapsulizabilityRolloutResponse')) {
...
console.log('Patched shared files for v5.331-v5.335 rollout milestones.')
