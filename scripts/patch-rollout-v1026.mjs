...
import { milestones, patchMeta } from './milestones-v1026-v1030.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./auditlineizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './auditlineizability/auditlineizability.module.js'")) {
...
if (!tests.includes("describe('auditlineizability rollout integration'")) {
...
if (!app.includes("from './auditlineizability-ui'")) {
  ...
  app = app.replace(
    '  NotarproofizabilityAdminSummaryResponse,\n  RunCapabilitiesResponse,',
    `  NotarproofizabilityAdminSummaryResponse,\n${typeBlock}\n  RunCapabilitiesResponse,`,
  )
...
`
  if (!readme.includes(`Current \`${m.version}\``)) {
    readme = readme.replace(
      'Current `v5.525` behavior:',
      `${block}Current \`v5.330\` behavior:`,
    )
  }
}
writeFileSync(readmePath, readme)

console.log('Patched shared files for v5.526-v5.530 rollout milestones.')
