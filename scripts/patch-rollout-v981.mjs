...
import { milestones, patchMeta } from './milestones-v981-v985.mjs'
...
const exportBlock = milestones
  ...
  .join('\n')
if (!index.includes('./riskizability-rollout.js')) {
  index = index.replace(
...
if (!appModule.includes("from './riskizability/riskizability.module.js'")) {
...
if (!tests.includes("describe('riskizability rollout integration'")) {
...
if (!app.includes("from './riskizability-ui'")) {
...
console.log('Patched shared files for v5.481-v5.485 rollout milestones.')
