...
import { milestones, patchMeta } from './milestones-v1056-v1060.mjs'
...
if (!appModule.includes("from './assurancevaultizability/assurancevaultizability.module.js'")) {
...
if (!app.includes("from './assurancevaultizability-ui'")) {
...
console.log('Patched shared files for v5.556-v5.560 rollout milestones.')
